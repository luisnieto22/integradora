              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li class="dropdown-submenu">
                            <a class="dropdown-item" href="SubirSecuencia2.php">Subir</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li class="dropdown-submenu">
                                    <a class="dropdown-item" href="SubirCriterios2.php">Subir</a>
                             ...
                             <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                  ...
                                  <li class="dropdown-submenu">
                                    <a class="dropdown-item" href="SubirActas2.php">Subir</a>
